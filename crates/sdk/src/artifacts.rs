...
pub fn export_solidity_plonk_bn254_verifier(_output_dir: impl Into<PathBuf>) -> Result<()> {
    todo!()
...
/// already been built.
#[allow(clippy::needless_pass_by_value)]
pub fn export_solidity_groth16_bn254_verifier(_output_dir: impl Into<PathBuf>) -> Result<()> {
    todo!()
    // let output_dir: PathBuf = output_dir.into();
    // let artifacts_dir = if sp1_prover::build::sp1_dev_mode() {
