...
pub const CYCLE_TRACKER_ELF: Elf = include_elf!("cycle-tracker-test");

pub const ED_ADD_ELF: Elf = include_elf!("ed-add-test");

pub const ED_DECOMPRESS_ELF: Elf = include_elf!("ed-decompress-test");

pub const KECCAK_PERMUTE_ELF: Elf = include_elf!("keccak-permute-test");
...
pub const SECP256R1_ADD_ELF: Elf = include_elf!("secp256r1-add-test");

pub const SECP256R1_DECOMPRESS_ELF: Elf = include_elf!("secp256r1-decompress-test");

pub const SECP256R1_DOUBLE_ELF: Elf = include_elf!("secp256r1-double-test");

pub const SHA_COMPRESS_ELF: Elf = include_elf!("sha-compress-test");

pub const SHA_EXTEND_ELF: Elf = include_elf!("sha-extend-test");

pub const SHA2_ELF: Elf = include_elf!("sha2-test");

pub const SSZ_WITHDRAWALS_ELF: Elf = include_elf!("ssz-withdrawals-test");

pub const BN254_ADD_ELF: Elf = include_elf!("bn254-add-test");

pub const BN254_DOUBLE_ELF: Elf = include_elf!("bn254-double-test");

pub const BN254_MUL_ELF: Elf = include_elf!("bn254-mul-test");

pub const SECP256K1_MUL_ELF: Elf = include_elf!("secp256k1-mul-test");

pub const BLS12381_ADD_ELF: Elf = include_elf!("bls12381-add-test");

pub const BLS12381_DOUBLE_ELF: Elf = include_elf!("bls12381-double-test");

pub const BLS12381_MUL_ELF: Elf = include_elf!("bls12381-mul-test");

pub const UINT256_MUL_ELF: Elf = include_elf!("biguint-mul-test");

pub const BLS12381_DECOMPRESS_ELF: Elf = include_elf!("bls-decompress-test");

pub const VERIFY_PROOF_ELF: Elf = include_elf!("verify-proof");
...
pub const GROTH16_BLAKE3_ELF: Elf = include_elf!("groth16_verify_blake3");
